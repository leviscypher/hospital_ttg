      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <form className="space-y-8">
            ...
            <button
              type="submit"
              className="bg-black text-white px-8 py-4 uppercase tracking-widest text-sm hover:bg-gray-800 transition-all">
              Gửi tin nhắn →
            </button>
          </form>
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-6 text-sm tracking-widest uppercase text-gray-600">
                <Link href="https://www.facebook.com/benhvienthachthat.vn/?ref=page_internal" prefetch>Facebook</Link>
                <a href="#">Youtube</a>
              </div>
            </div>
          </div>
